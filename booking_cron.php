    ...
    if($result_booking !== false){
			foreach($result_booking as $key=>$lb){
                ...
                if($fromdatechk){
                    ...
                    $from_name = 'Met HMS';
                    $content = '<tr><td style="padding: 20px 20px 0 20px;background: #fff;"><p style="margin: 20px 0 20px;">Your booking at Met HMS for check-in date: '.gmstrftime(DATE_FORMAT, $lb['from_date']).' has been cancelled.</p>
