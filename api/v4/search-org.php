...
<form id="bookingsearch" name="bookingsearch" action="<?php echo DOCBASE.$sys_pages['booking']['alias']; ?>" method="get" class="booking-search">
    ...
    <div class="row">
     <?php
                ...
                <div class="col-md-3 col-sm-4 col-xs-12">
                    <div class="input-wrapper form-inline" id="input_destination">
                        ...
                        <div class="input-group">
                            ...
                            if(count($result_search_destination) > 30){ ?>
                                ...
                                <select name="destination_id" id="destination_id" class="form-control selectpicker">
        ...
        <div class="col-md-<?php echo ($nb_search_destinations > 0) ? 4 : 7; ?> col-sm-<?php echo ($nb_search_destinations > 0) ? 4 : 12; ?> col-xs-12">
