...
<form id="bookingsearch" name="bookingsearch" action="<?php echo $offer_alias?>" method="post" class="booking-search">
    <?php
    if(isset($hotel_id)){ ?>
    ...
    <div class="row">
        ...
        <div class="col-md-<?php echo ($nb_search_destinations > 0) ? 7 : 7; ?> col-sm-<?php echo ($nb_search_destinations > 0) ? 6 : 12; ?> col-xs-12">
            <div class="input-wrapper datepicker-wrapper form-inline">
                ...
                <div class="input-group from-date">
                    <input type="text" class="form-control text-right" id="pfrom_picker" name="from_date" value="<?php echo $from_date; ?>" placeholder="<?php echo $texts['CHECK_IN']; ?>" autocomplete="off">
                </div>
                <i class="fas fa-fw fa-long-arrow-alt-right"></i>
                <div class="input-group to-date">
                    <input type="text" class="form-control" id="pto_picker" name="to_date" value="<?php echo $to_date; ?>" placeholder="<?php echo $texts['CHECK_OUT']; ?>" autocomplete="off">
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-6">
            ...
            <div class="form-group">
                 <div class="input-room-row" id="abc">
                     <?php
                     $rm=0;
                     $gest=0;
                ...
                <div class="room-container" id="room_container"  style="display:none">
                    <div id="rooms_rows">
                         <?php if(isset($_SESSION['ab']['norm'])) { 
                           foreach($_SESSION['ab']['norm'] as $k=>$ab){ $a = $k;?>
                               <div class="room-rows">
