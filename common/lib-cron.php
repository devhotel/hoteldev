...
function sendMail($recipient_email, $recipient_name, $subject, $content, $reply_email = '', $reply_name = '', $from_email = '', $from_name = '', $attachements = array(), $emails_copy = '')
{
    ...
    $body = '<html><head><meta charset="utf-8"></head><body><div style="width: 700px;margin: 0 auto;"><table cellspacing="0" cellpadding="0" style="width: 100%;border:10px solid #fafafa;"><tbody><tr><td style="text-align: center;padding: 20px 20px 0 20px;background: #fff;"><a href="#"><img src="cid:header-mail" alt="" /></a>
    ...
    try {
        ...
        $mail->AddEmbeddedImage('images/logo.png', 'header-mail', 'header-mail.png');
        $mail->MsgHTML($body);
