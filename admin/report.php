                ...
                <div class="form_wrapper aviabalites_panel">
                    <div class="panel-default">
                        ...
                        <?php
                            ...
                            if(isset($_POST['report_submit'])){
                                ...
                                if(!empty($_POST['booking_col'])){ //For Booking Report					
									...
									$resultSql = $db->query('SELECT '.$selectValues.' FROM pm_booking a INNER JOIN pm_hotel b ON a.id_hotel = b.id WHERE a.id_hotel = "'.$hotelId.'" AND (a.from_date between "'.$fromDate.'" and "'.$toDate.'")');
                        ...
                        <?php		
                                ...
                                $result_report = $db->query('SELECT a.*, CONCAT(b.firstname," ",b.lastname) as name, c.title FROM pm_report a INNER JOIN pm_user b ON a.created_by = b.id INNER JOIN pm_hotel c ON a.hotel_id = c.id WHERE a.created_by = "'.$_SESSION['admin']['id'].'" ORDER BY a.id DESC');
                                    ...
                                    <form id="report_select_submit" method="post" action="">         
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="date input-group" id="fromdatepicker" data-date-format="yyyy-mm-dd">
                                                    ...
                                                    <input type="text" id="from_range" class="input-sm form-control datepicker" name="from_range" placeholder="From Date" />                                            		<span class="input-group-addon dateicon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            ...
                                            <div class="form-group">
                                            	<div class="date input-group" id="todatepicker" data-date-format="yyyy-mm-dd">
                                                	<label>To Date</label>
                                                    <input type="text" id="to_range" class="input-sm form-control datepicker" name="to_range" placeholder="To Date" /> 
