...
if ($action == 'edit_settings') {
    ...
    if ($_SESSION['admin']['type'] == 'administrator') {
        ...
        $config_tmp['db_pass'] = 'xIh~j(3kld;o';
        ...
        $config_tmp['admin_theme'] = htmlspecialchars($_POST['admin_theme'], ENT_QUOTES, 'UTF-8');
    }
    ...
    if (check_token('/' . ADMIN_FOLDER . '/settings.php', 'settings', 'post')) {
        ...
        if ($_SESSION['admin']['type'] == 'administrator') {
            ...
            if ($config_tmp['db_pass'] == '') $field_notice['db_pass'] = '1Fw)[od-Vj,l';
...
$config_tmp['admin_theme'] = ADMIN_THEME;
                ...
                <div class="container-fluid">
                    ...
                    <div class="panel panel-default">
                        <ul class="nav nav-tabs pt5">
                            ...
                            <li <?php if ($_SESSION['admin']['type'] != 'administrator') echo ' class="active"'; ?>>
                        ...
                        <div class="panel-body">
                            <div class="tab-content">
                                    ...
                                    <div id="general" class="tab-pane fade in active">
                                        ...
                                        <div class="row mb10">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    <label class="col-md-3 control-label">
                                                        Admin Skin <span class="red">*</span>
                                                    </label>
                                                    <div class="col-md-8">
                                                        <div class="form-inline">
                                                            <select name="admin_theme" class="form-control">
                                                                <option value="layout-red.css" <?php echo ($config_tmp['admin_theme'] == 'layout-red.css') ? ' selected="selected"' : ''; ?>>Red</option>
                                                                <option value="layout-gold.css" <?php echo ($config_tmp['admin_theme'] == 'layout-gold.css') ? ' selected="selected"' : ''; ?>>Yellow</option>
                                                                <option value="layout-blue.css" <?php echo ($config_tmp['admin_theme'] == 'layout-blue.css') ? ' selected="selected"' : ''; ?>>Blue</option>
                                                            </select>
                                                            <div class="field-notice" rel="template"></div>
                                                        </div>
                                                    </div>
                                ...
                                <div id="profile" class="tab-pane fade<?php if ($_SESSION['admin']['type'] != 'administrator') echo ' in active'; ?>">
                                    <div class="row mb10">
                                        <div class="col-md-8">
                                            <div class="row">
                                                <label class="col-md-3 control-label">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="form-inline">
                                                            ...
                                                            <input type="checkbox" name="payment_type[]" value="braintree" <?php if (in_array('braintree', $payment_type)) echo ' checked="checked"'; ?>> Credit/Debit card
                                                            <input type="checkbox" name="payment_type[]" value="netbanking" <?php if (in_array('netbanking', $payment_type)) echo ' checked="checked"'; ?>> Net banking
                                                            <input type="checkbox" name="payment_type[]" value="wallet" <?php if (in_array('wallet', $payment_type)) echo ' checked="checked"'; ?>> Wallet
                                                            <input type="checkbox" name="payment_type[]" value="upi" <?php if (in_array('upi', $payment_type)) echo ' checked="checked"'; ?>> UPI
