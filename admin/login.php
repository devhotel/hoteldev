...
define('TITLE_ELEMENT', 'Admin  - ' . $texts['LOGIN']);
...
if ($db !== false && isset($_POST['login'])) {
    ...
    if (check_token('/' . ADMIN_FOLDER . '/login.php', 'login', 'post')) {
        ...
        $result_user = $db->query('SELECT * FROM pm_user WHERE login = ' . $db->quote($user) . ' AND pass = ' . $db->quote(md5($password)) . ' AND type = "administrator" AND checked = 1');
    ...
    <div class="loginwrapper">
        <div class="loginleft">
            ...
            <div class="logininfo">
                ...
                <!-- <p>Logging is as Property Admin only</p> -->
            </div>
        </div>
                    ...
                    <?php } else { ?>
                        ...
                        <?php
                            ...
                            <span class="labelbox">
                                ...
                                <a href="javascript:void(0);" class="eyeicon" id="showpass"><img src="images/eye-icon-visible.png" alt="" /></a>
                                <a href="javascript:void(0);" class="eyeicon" id="hidepass" style="display:none;"><img src="images/eye-icon--not-visible.png" alt="" /></a>
                            </span>
                            ...
                            <p>By Logging into the account you are agreeing with our <a target="_blank" href="<?= base_url('/terms-conditions') ?>">Terms of Use</a> and <a target="_blank" href="<?= base_url('/terms-conditions') ?>">Privacy Policy</a></p>
                        <?php
                        } ?>
