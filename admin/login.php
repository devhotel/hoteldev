                ...
                if ($action == 'reset') { ?>
                    ...
                    <?php } else { ?>
                        ...
                        <?php
                            ...
                            <p>By Logging into the account you are agreeing with our <a target="_blank" href="<?= base_url('/term-and-condition') ?>">Terms of Use</a> and <a target="_blank" href="<?= base_url('/privacy-policy') ?>">Privacy Policy</a></p>
                        <?php
                        } ?>
