...
if (isset($_REQUEST['from_date'])) $from_date = htmlentities($_REQUEST['from_date'], ENT_QUOTES, 'UTF-8');
if (isset($_REQUEST['to_date'])) {
    $to_date = htmlentities($_REQUEST['to_date'], ENT_QUOTES, 'UTF-8');
} else {
    //$to_date = htmlentities($_POST['from_date'], ENT_QUOTES, 'UTF-8');
    if (isset($_REQUEST['from_date'])) $to_date = htmlentities($_REQUEST['from_date'], ENT_QUOTES, 'UTF-8');
}
...
if (isset($_REQUEST['add_prices']) && (in_array('add', $permissions) || in_array('all', $permissions))) {
    ...
    <script>
        $(function() {
            ...
            $('.timeline-default:not(.start-d):not(.start-end-d):not(.full)').on('click', function(e) {
                if (stprid == '') {
                    stprid = $(this).parent().attr("id");
                }
                if (stprid) {
                    ndprid = $(this).parent().attr("id");
                    if (stprid != ndprid) {
                        $("a.pending").remove();
                        $('#context-menu').hide();
                        stprid = '';
                ...
                if (!$(e.target).closest('a').length) {
                    ...
                    } else if ($(this).hasClass('start-d')) {
                        $(this + " a.pending").remove();
                        $(this).removeClass('start-d');
                        start_clicked = false;
                    } else if ($(this).hasClass('end-d')) {
                        $(this).removeClass('end-d').empty('a.pending');
                        start_clicked = false;
                    }
                }
            });
                ...
                if (!$(e.target).closest('a').length) {
                    ...
                    if (curr_room > 0 && curr_room == room &&
                        ...
                        if (!booked) {
                            ...
                            $('#context-menu').html('<a href="new.php?view=form&id=0&hotel_id=' + hotel + '&booking_from_date=' + curr_date + '&booking_to_date=' + date + '&booking_nights=' + nnights + '&booking_status_0=1&booking_room_id_hotel_0=' + hotel + '&booking_room_id_room_0=' + room + '&booking_room_title_0=' + room_title + '">New booking</a>' +
                    ...
                    if ($db !== false) {
                        ...
                        <fieldset>
                                        ...
                                        <div class="form-group mb5">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="room_id">
                                                    ...
                                                    //if($_SESSION['admin']['type'] == 'hotel') $query_room .= ' AND h.users REGEXP \'(^|,)'.$_SESSION['admin']['id'].'(,|$)\'';
                            ...
                            <fieldset>
                                ...
                                <form method="get" action="availabilities.php">
                                    <div class="row">
                                        <div class="col-md-12 form-inline">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fas fa-fw fa-calendar"></i> <?php echo $texts['FROM_DATE']; ?></div>
                                                    <input type="text" class="form-control datepicker" id="from_picker" autocomplete="off" rel="to_picker" name="from_date" value="<?php echo $from_date; ?>">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fas fa-fw fa-calendar"></i> <?php echo $texts['TO_DATE']; ?></div>
                                                    <input type="text" class="form-control datepicker" id="to_picker" autocomplete="off" rel="from_picker" name="to_date" value="<?php echo $to_date; ?>">
                                                </div>
                        ...
                        LIMIT 1');
                             ...
                             WHERE r.checked = 1
                                ...
                                if ($result_room !== false) {
                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3 col-sm-4 avl1">
                                            <div class="rooms-title">
                                                <?php
                                                foreach ($rooms as $room_id => $row) {
                                                    $hotel_title = db_getFieldValue($db, 'pm_hotel', 'title', $row['id_hotel'], $lang = 0);
                                                ?>
                                                    <div class="room-title bg-info text-info" id="room-title-<?php echo $room_id; ?>">
                                                        <?php echo '<b>' . $hotel_title . '</b> - ' . $row['room_title']; ?>
                                                    </div>
                                                    <?php
                                                    $initials = @getInitials($row['room_title']);
                                                    $result2 = $db->query('SELECT * FROM pm_room_names WHERE id_room = ' . $room_id);
                                                    if ($result2 !== false && $db->last_row_count() > 0) {
                                                        foreach ($result2 as $j => $ro) { ?>

                                                            <div class="room-label">
                                                                <span id="room-num-<?php echo $room_id; ?>-<?php echo $j; ?>"><?php echo $ro['name'] . ' #' . ($j + 1); ?></span>
                                                                <?php if ($j + 1 > $row['stock']) echo '<div class="label label-danger"><i class="fas fa-fw fa-exclamation-circle"></i> ' . $texts['OVERBOOKING'] . '</div>'; ?>
                                                            </div>
                                        ...
                                        <div class="col-lg-10 col-md-9 col-sm-8 avl2">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="room-row">
                                                        <div class="timeline-row" style="width: <?php echo $width; ?>px;">
                                                            ...
                                                            for ($date = $from_time; $date <= $to_time; $date += 86400) {
                                                                ...
                                                                <div class="timeline-cel timeline-price<?php if ($d == 6 || $d == 7) echo ' bg-warning'; ?><?php if ($date == $today) echo ' today'; ?>">
                                                                    ...
                                                                    <span class="text-muted"><?php echo $remain; ?> Left <?php //echo '/'. $stock; 
                                                                                                                            ?></span>
                                                                </div>
                                                            <?php
                                                            } ?>
                                                        ...
                                                        for ($n = 0; $n <= $max_n; $n++) { ?>
                                                            ...
                                                            <div class="timeline-row" id="room-row-<?php echo $room_id . '-' . $n; ?>" style="width: <?php echo $width; ?>px;">
                                                                <?php
                                                                $prev_date = $time_1d_before;
                                                                for ($date = $from_time; $date <= $to_time; $date += 86400) {
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <fieldset id="availability-legend">
                                                ...
                                                <div class="col-xs-6 col-sm-5 col-md-4 col-lg-2">
                                                    ...
                                                    <div class="legend-label mb5"><?php echo $texts['IN_HOUSE']; ?></div>
                                                    <div class="timeline-legend confirmed"></div>
                                                    <div class="legend-label mb5"><?php echo $texts['CONFIRMED']; ?></div>
                                                    <div class="timeline-legend pending"></div>
                                                    <div class="legend-label mb5"><?php echo $texts['PENDING']; ?></div>
                                                    <div class="timeline-legend checked-out"></div>
                                                    <div class="legend-label mb5"><?php echo $texts['CHECKED_OUT']; ?></div>
                                                    <div class="timeline-legend closed"></div>
                                                    <div class="legend-label mb5"><?php echo $texts['UNAVAILABLE']; ?></div>
                                                </div>
...
<?php
    ...
    <script>
        ...
        function get_hotels_by_destination() {
            ...
            hotels.empty();
            $.ajax({
                url: '<?php echo DOCBASE . ADMIN_FOLDER; ?>/get_hotel.php',
                type: 'POST',
                data: {
