<script>
    $(function() {
        ...
        var entry_booking_payment = $('#entry_booking_payment');

        var booking_id_user = $('[name="booking_id_user_0[0]"');
        var fc_booking_payment_amount = $('[name="booking_payment_amount_0[0]"');
        from_date_input.datepicker("destroy");
        to_date_input.datepicker("destroy");
        from_date_input.attr('readonly', true);
        to_date_input.attr('readonly', true);
        booking_id_user.attr('readonly', true);
        booking_id_user.css("pointer-events", "none");
        fc_booking_payment_amount.attr('readonly', true);
        entry_booking_payment.css('display', 'none');
        ...
        function updateNights() {
            ...
            fc_booking_payment_amount.val(total_input.val());
        }
