                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <?php $result_hotels = $db->query('SELECT * FROM pm_hotel WHERE checked = 1 AND lang = '.LANG_ID);  ?>
                                                    ...
                                                    <div class="timeline-row">
                                                        ...
                                                        for($date = $dates; $date <$week; $date += 86400){
                                                            ...
                                                            <div class="timeline-cel timeline-price<?php if($d == 6 || $d == 7) echo ' bg-warning'; ?><?php if($date == $today) echo ' today'; ?>">
                                                                <?php echo mb_strtoupper(strftime('%d/%m', $date)); ?><br>
                                                                <div><?php echo $room_title; ?>-<?php if($price > 0) echo formatPrice($price*CURRENCY_RATE); ?></div>
