                                                    ...
                                                    <div class="timeline-row">
                                                        ...
                                                        for($date = $dates; $date <$week; $date += 86400){
                                                            ...
                                                            <div class="timeline-cel timeline-price<?php if($d == 6 || $d == 7) echo ' bg-warning'; ?><?php if($date == $today) echo ' today'; ?>">
                                                                ...
                                                                <?php if($remain > 0) {?>
                                                                    <span class="btn btn-success btn-sm"><?php echo $remain; ?> / <?php echo $stock; ?> available</span>
                                                                <?php }else{?>
                                                                    <span class="btn btn-danger btn-sm"><?php echo $remain; ?> / <?php echo $stock; ?> Not available</span>
                                                                <?php }?>
                                                            </div>
                                                            <?php } 
                                                        ?>
