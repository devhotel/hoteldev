                ...
                <div class="mb20">
                    ...
                    <div class="row mb10">
                        <div class="col-md-12 description" itemprop="description">
                         ...
                         <div class="col-md-12 facilities" itemprop="facilities">
                           <?php 
                        ...
                        <div class="col-md-12">
                         ...
                         <div class="col-md-12" class="booking_div" itemprop="description">
                             <?php
                                ...
                                $end_date = gmdate('d/m/Y', $offer['day_end']);
                             ?>
                             <script>
                               ...
                               $SrtDate = date('d/m/Y');
                               $NewDate=Date('d/M/Y', strtotime("+".$offer['no_day_night']." days"));
                               $_SESSION['from_date']= date('d/m/Y');
                               $_SESSION['to_date']=$NewDate;
                               ?>
                                  <form action="<?php echo $offer_alias;?>" method="post">
                                    <input type="hidden" name="nights" value="<?php echo $offer['no_day_night']; ?>">
                                    <input type="hidden" name="from_date" value="<?php echo $SrtDate; ?>">
                                    <input type="hidden" name="to_date" value="<?php echo $NewDate; ?>">
