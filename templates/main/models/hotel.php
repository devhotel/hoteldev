                                                                    ...
                                                                    <div class="pt10 form-inline">
                                                                        ...
                                                                        <div class="nrom rooms_count" id="nrom_<?php echo $id_room; ?>">
                                                                            ...
                                                                            <div style="display:none;">
                                                                                ...
                                                                                <select id="rms_<?php echo $id_room; ?>" name="num_rooms[<?php echo $id_room; ?>]" class="form-control room_select selectpicker btn-group-sm sendAjaxForm" data-target="#room-options-<?php echo $id_room; ?>" data-extratarget="#booking-amount_<?php echo $hotel_id; ?>" data-action="https://devhotel.fitser.com/api/v3/change_num_rooms.php?room=<?php echo $id_room; ?>">
                                                                                    <?php
