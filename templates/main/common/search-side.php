...
<div class="side_search">
    <form id="form_search" action="<?php echo DOCBASE . $sys_pages['booking']['alias']; ?>" method="get" class="booking-search">
        ...
        <input type="hidden" name="destination_id" id="destination_id" value="<?php if ($_SESSION['destination_id']) {
                                                                                    echo $_SESSION['destination_id'];
                                                                                } else {
                                                                                    echo 1;
                                                                                } ?>">
        <input type="hidden" name="accommodation_id" id="accommodation_id" value="<?php if ($_SESSION['accommodation_id']) {
                                                                                        echo $_SESSION['accommodation_id'];
                                                                                    } else {
                                                                                        echo 0;
                                                                                    } ?>">
