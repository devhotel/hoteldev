...
if(isset($_POST['book']) || (ENABLE_BOOKING_REQUESTS == 1 && isset($_POST['request']))){
    ...
    $gstin = htmlentities($_POST['gstin'], ENT_COMPAT, 'UTF-8');
    $govid_type = htmlentities($_POST['govid_type'], ENT_COMPAT, 'UTF-8');
    $govid = htmlentities($_POST['govid'], ENT_COMPAT, 'UTF-8');
                    ...
                    <div class="leftbox">   
                     <?php
                        ...
                        <fieldset id="details_signup" <?php echo ($user_id == 0) ? 'style="display:none"' : 'style="display:block"'; ?>>
                            ...
                            <div class="row form-group">
                                <label class="col-lg-3 control-label"><?php echo $texts['MOBILE']; ?><sup style="color:red">*</sup></label>
                                <div class="col-lg-9">
                        ...
                        if($user_id == 0){ ?>
                            ...
                            <div class="row form-group">
                                <label class="col-lg-3 control-label"><?php echo $texts['ADDRESS']; ?> <sup style="color:red">*</sup></label>
                                <div class="col-lg-9">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-xs-8">
                                                <p>
                                                    ...
                                                    echo ($room['adults']+$room['children']).' '.$texts['PERSON'].' - 
                                                        '.($room['adults']>1?$texts['ADULTS']:$texts['ADULT']).': '.$room['adults'].' / 
