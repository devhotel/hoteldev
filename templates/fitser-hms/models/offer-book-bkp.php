    ...
    if($result !== false && $db->last_row_count() == 1){
        ...
        if(isset($_POST['num_room']) && is_numeric($_POST['num_room'])) $_SESSION['num_room'] = $_POST['num_room'];
        ...
        /*********** Num adults ************/
        if(isset($_POST['ab']) && is_array($_POST['ab'])) $_SESSION['ab'] = $_POST['ab'];
        ...
        <div id="content" class="pb30">
            ...
            <section class="hotel_details_new">
              ...
              <div class="hotel_about">
                 <h2>About <?php echo $hotel['title']; ?></h2>
                 <h3>Address</h3>
            ...
            if($hotel['cancel_policy'] !=""){
             ...
             <?php } ?>
             <div class="hotel_review_panel">
                 <h2>Rating & Reviews For <?php echo $hotel['title']; ?></h2>
                 <?php
