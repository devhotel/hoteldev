            ...
            if ($result_budget_hotel !== false) {
                foreach ($result_budget_hotel as $i => $row) {
                    ...
                    if ($result_budget_room !== false) {
                        // echo "<pre>";
                        // print_r($result_budget_room );
                        // die;
                        foreach ($result_budget_room as $row) {
                            //echo $_SESSION['num_room'] .' <= '.$row['stock'];
                            if ($_SESSION['num_room'] <= $row['stock']) {
                                ...
                                // echo "<pre>";
                                // print_r($res_hotel[$id_hotel]); die;
                                         ...
                                         <?php 
                                            ...
                                            if (isset($hotel_prices[$id_hotel]) && $hotel_prices[$id_hotel] > 0) { ?>
                                                ...
                                                if ($hotel_regular_price != "" && $hotel_regular_price > $hotel_prices[$id_hotel]) { ?>
                                                    <span itemprop="priceRange"><del><?php echo formatPrice($hotel_regular_price * CURRENCY_RATE); ?></del></span>
                                                <?php } ?>
