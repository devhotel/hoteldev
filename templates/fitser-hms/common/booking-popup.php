                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    ...
                                    if ($row['total'] != $row['paid']) {
                                        ...
                                        $due =  $row['total'] - $paidAmnt;
                                    ?>
                                        <!-- <p class="edtpara">Due Amount : <span><?php //echo formatPrice($row['total'] * CURRENCY_RATE); 
                                                                                    ?></span></p> -->
                                        <p class="edtpara">Due Amount : <span><?php echo formatPrice($due * CURRENCY_RATE); ?></span></p>
                                    <?php } else if ($row['total'] == $row['paid']) { ?>
                                        <p class="edtpara">Paid Amount : <span><?php echo formatPrice($row['paid'] * CURRENCY_RATE); ?></span></p>
                                    <?php } ?>
                                    <?php
