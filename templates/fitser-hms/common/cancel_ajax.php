...
VALUES(:id_booking, :id_room, :cancel_type, :reason, :days, :rooms, :booking_amount, :refund_charge, :refund_amount, :cancel_element)";
	...
	if (isset($_POST['booking_id'])) {
		...
		$content1 .= '<p style="margin: 0 0 20px;">Cheers <br>Team HMS </p></td></tr>';
		...
		$content .= '<p style="margin: 0 0 20px;">Cheers <br>Team HMS </p></td></tr>';


		$from_email = 'cancellation@fitser.com';
		$from_name = 'HMS';
