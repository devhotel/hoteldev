...
<form id="bookingsearch" name="bookingsearch" action="<?php echo DOCBASE.$sys_pages['booking']['alias']; ?>" method="get" class="booking-search">
    <?php
    if(isset($hotel_id)){ ?>
        <input type="hidden" id="src_hotel_id" name="hotel_id" value="<?php echo $hotel_id; ?>">
    <?php } ?>
        ...
        <div class="col-md-3 col-sm-4 col-xs-12">
            <div class="input-wrapper form-inline" id="input_destination">
                ...
                <div class="input-group">
                    <input type="text" name="destination_name" id="search_str" class="form-control"   value="<?php echo $destination_name; ?>" placeholder="<?php echo $texts['DESTINATION'] ; ?>" autocomplete="off">
