      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="footer_social">
            <a href="https://play.google.com/store/apps/details?id=com.methms&hl=en" target="_blank"><img src="<?php echo getFromTemplate("images/google-play-icon.png"); ?>">
  ...
  var App = {
    ...
    sendUserData: function() {
      FB.api('/me?fields=name,email', function(data) {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url('/templates/fitser-hms/common/register/facebook_callback.php'); ?>",
          data: data,
          cache: false,
  ...
  function onSuccess(googleUser) {
    ...
    gapi.client.load('oauth2', 'v2', function() {
      ...
      request.execute(function(resp) {
        ...
        //alert(resp.email);
        $.ajax({
          url: "<?php echo base_url('/templates/fitser-hms/common/register/google_callback.php'); ?>",
          type: "POST",
          cache: false,
          data: {
            sign_user: sign_user
