...
<head>
    ...
    <title><?php echo $title_tag; ?> : <?php echo SITE_TITLE; ?></title>
    ...
    <meta name="robots" content="<?php if ($page['robots'] != "") echo $page['robots'];
    ...
    <link rel="stylesheet" href="<?php echo DOCBASE; ?>common/bootstrap/css/bootstrap.min.css" media="all">
    <?php
    if (RTL_DIR) { ?>
    ...
    <link rel="stylesheet" href="<?php echo DOCBASE; ?>common/css/shortcodes.css" media="all">
    <link rel="stylesheet" href="//use.fontawesome.com/releases/v5.0.6/css/all.css" media="all">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" media="all">
    <link rel="stylesheet" href="<?php echo DOCBASE . 'js/plugins/royalslider/royalslider.css'; ?>" media="all">
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap.min.css" media="all">
    <link rel="stylesheet" href="<?php echo getFromTemplate("css/layout.css"); ?>" media="all">
    <link rel="stylesheet" href="<?php echo getFromTemplate("css/colors.css"); ?>" id="colors">
    <link rel="stylesheet" href="<?php echo getFromTemplate("css/main.css"); ?>" media="all">
    <link rel="stylesheet" href="<?php echo getFromTemplate("css/custom.css"); ?>" media="all">
    ...
    <script src="<?php echo getFromTemplate("js/owl-carousel/owl.carousel.min.js");
                    ?>"></script>
    ...
    <script>
        Modernizr.load({
            load: [
                ...
                <?php if (LANG_TAG != "en") : ?> '//rawgit.com/jquery/jquery-ui/master/ui/i18n/datepicker-<?php echo LANG_TAG; ?>.js', <?php endif; ?> '//cdnjs.cloudflare.com/ajax/libs/jquery-cookie/1.4.1/jquery.cookie.min.js',
    ...
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v5.0&appId=393269364696466&autoLogAppEvents=1"></script>
    <meta name="google-signin-client_id" content="726299600516-d0td6ivb0dlrmd7ekgfv7gnuo9r0n961.apps.googleusercontent.com">
...
<body id="page-<?php echo $page_id; ?>" itemscope itemtype="http://schema.org/WebPage" <?php if (RTL_DIR) echo " dir=\"rtl\""; ?>>
    ...
    <div id="loader-wrapper">
        <div id="loader"><img src="<?php echo getFromTemplate("images/loader.gif"); ?>"></div>
    </div>
        ...
        <div id="mainHeader">
            <div class="container-fluid">
                <div class="nav_wrapper">
                    <ul class="acc_nav">
                        <li class="primary btn-nav"><a itemprop="email" dir="ltr" href="javascript:void(0);"><i class="fas fa-fw fa-envelope" aria-hidden="true"></i> <?php echo EMAIL; ?></a></li>
                        <li class="primary btn-nav"><a href="javascript:void(0);" itemprop="telephone" dir="ltr"><i class="fas fa-fw fa-phone" aria-hidden="true"></i> <?php echo PHONE; ?></a></li>
                        <li class="primary btn-nav">
                                    ...
                                    <div class="dropdown">
                                        <a class="firstLevel dropdown-toggle" data-toggle="dropdown" href="#">
                                            ...
                                            <span class="hidden-sm hidden-md">
                                                <?php
                                                if (isset($_SESSION['user'])) {
                                                    if (isset($_COOKIE["stored_user_name"]) && $_COOKIE["stored_user_name"] == $_SESSION['user']['login']) {
                                                        echo 'Welcome Back, ';
                                                    } else {
                                                        echo 'Welcome, ';
                                                    }
                                                ...
                                                ?>
                                                <?php
                                                if ($_SESSION['user']['login'] != "") echo $_SESSION['user']['name'];
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu" id="user-menu">
                                            ...
                                            if ($_SESSION['user']['type'] == "registered") { ?>
                                                ...
                                                <li><a href="<?php echo DOCBASE . $sys_pages['account']['alias'] . '?view=change-password'; ?>"><i class="fas fa-fw fa-edit"></i> <?php echo $texts['CHANGE_PASSWORD']; ?></a></li>
                                            ...
                                            <?php
                                                ...
                                                <li><a href="<?php echo DOCBASE; ?>admin" data-refresh="true"><i class="fas fa-fw fa-user"></i>Dashboard</a></li>
                                                <li><a href="#" class="sendAjaxForm" data-action="<?php echo DOCBASE; ?>templates/<?php echo TEMPLATE; ?>/common/register/logout.php" data-refresh="true"><i class="fas fa-fw fa-power-off"></i> <?php echo $texts['LOG_OUT']; ?></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                            ...
                            <?php
                                ...
                                <a class="firstLevel" href="<?php echo getUrl(true) . DOCBASE . 'login'; ?>">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li>
                                    ...
                                    <form method="post" action="<?php //echo DOCBASE.$sys_pages['search']['alias']; 
                                ...
                                if (empty($nav['id_parent']) || @$menus['main'][$nav['id_parent']]['id_item'] == $homepage['id']) { ?>
                                    <li class="primary nav-<?php echo $nav_id; ?>">
                                        ...
                                        <?php
                                            ...
                                            <a class="dropdown-toggle disabled firstLevel<?php if ($hasChildNav) echo " hasSubMenu";
                                                                                            if ($top_nav_id == $nav_id) echo " active"; ?>" href="<?php echo $nav['href']; ?>" title="<?php echo $nav['title']; ?>"><?php echo $nav['name']; ?></a>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div class="signup-form">
                                            <form method="post" action="<?php echo DOCBASE . $page['alias']; ?>" class="ajax-form">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fas fa-fw fa-user-plus"></i></div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="fas fa-fw fa-mobile"></i></div>
                                                        <input type="text" class="form-control" name="mobile" value="" placeholder="<?php echo $texts['MOBILE']; ?> *">
                                                    </div>
