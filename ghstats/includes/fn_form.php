...
function getFieldsFromNode($db, $itemList)
{
    ...
    foreach ($itemList as $item) {
        ...
        if (in_array($_SESSION['ghs']['type'], $roles) || in_array('all', $roles)) {
            ...
            if (!empty($itemOptions)) {
                ...
                if ($db !== false && $optionTable != '' && $fieldLabel != '' && $fieldValue != '') {
                    ...
                    if (!in_array($_SESSION['ghs']['type'], array('administrator', 'manager', 'editor')) && db_column_exists($db, $optionTable, 'users')) {
                        $query_option_cond .= ($query_option_cond != '') ? ' AND ' : ' WHERE ';
                        $query_option_cond .= 'users REGEXP \'(^|,)' . $_SESSION['ghs']['id'] . '(,|$)\'';
                    }
