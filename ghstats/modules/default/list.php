...
// Inclusions
require_once(SYSBASE.'ghstats/includes/fn_list.php');
...
if($db !== false){
    ...
    if(!in_array($_SESSION['ghs']['type'], array('administrator', 'manager', 'editor')) && db_column_exists($db, 'pm_'.MODULE, 'users')){
        if($condition != '') $condition .= ' AND';
        $condition .= ' users REGEXP \'(^|,)'.$_SESSION['ghs']['id'].'(,|$)\'';
    }
...
<!DOCTYPE html>
<head>
    <?php include(SYSBASE.'ghstats/includes/inc_header_list.php'); ?>
</head>
<body>
    <div id="wrapper">
        <?php include(SYSBASE.'ghstats/includes/inc_top.php'); ?>
        <div id="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 clearfix">
                            ...
                            <div class="pull-left text-right">
                                 &nbsp;&nbsp;
                                <a href="/ghstats" class="btn btn-primary mt15 mb15">
                                  ...
                                  if(in_array('add', $permissions) || in_array('all', $permissions)){ 
                                   if(!in_array(MODULE, $btn)){?>
                                    <a href="index.php?view=form&id=0" class="btn btn-primary mt15 mb15">
                                        <i class="fas fa-fw fa-plus-circle"></i> New Stats User
                                    </a>
                                    <?php
                                    }
                                  }
                                            ...
                                            <tbody>
                                                ...
                                                if($result !== false){
                                                    ...
                                                    foreach($result as $i => $row){
                                                        $idk++;
                                                        if(MODULE=='stats_user' && $row['id']==1 && $row['id']!= $_SESSION['ghs']['id']) continue;
                                                        $id = $row['id'];
                                                        ...
                                                        <tr id="item_<?php echo $id ?>" class="<?php echo $class;?>">
                                                            ...
                                                            <td class="text-center">
                                                                <?php
                                                                 if(in_array('all', $permissions) || in_array('view', $permissions)){
                                                                  if(MODULE=='booking'){ ?>
                                                                      <a href="popup-details.php" data-params="id=<?php echo $id; ?>" title="Booking details" class="dropdown-item ajax-popup-link tips"> <?php echo $id; ?></a>
                                                                  <?php
                                                                  }else{ ?>
                                                                     <?php echo $idk; ?>
                                                                 <?php }
                                                            ...
                                                            if(MODULE=='booking'){$status = $row['status']; ?>
                                                                <td class="text-center status">
                                                                    <?php
                                                            ...
                                                            <td class="text-center action_btn">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    if($checked == 0){ ?>
                                                                        <a class="tips dropdown-item" href="index.php?view=list&id=<?php echo $id; ?>&csrf_token=<?php echo $csrf_token; ?>&action=check" title="<?php echo $texts['PUBLISH']; ?>"><i class="fas fa-fw fa-check text-success"></i><?php //echo $texts['PUBLISH']; ?></a>
                                                                        <a class="tips dropdown-item" href="index.php?view=list&id=<?php echo $id; ?>&csrf_token=<?php echo $csrf_token; ?>&action=uncheck" title="<?php echo $texts['UNPUBLISH']; ?>"><i class="fas fa-fw fa-ban text-danger"></i><?php //echo $texts['UNPUBLISH']; ?></a>
                                                                ...
                                                                if(MODULE!='wallet'){
                                                                    if(in_array('edit', $permissions) || in_array('all', $permissions) || in_array('view', $permissions)){ ?>
                                                                        <a class="tips dropdown-item" href="index.php?view=form&id=<?php echo $id; ?>" title="<?php echo $texts['EDIT']; ?>"><i class="fas fa-fw fa-edit"></i><?php //echo $texts['EDIT']; ?></a>
                                                                     <?php
                                                                    }
                                                                }else{ ?>
                                                               ...
                                                               if(in_array('edit', $permissions) || in_array('all', $permissions) || in_array('view', $permissions)){
                                                                  ...
                                                                  if(MODULE=='booking'){ ?>
                                                                   ...
                                                                   <?php $today=time();
                                                                    ...
                                                                    if($row['status']!=2){?>
                                                                      <a href="cancel_popup.php" data-params="id=<?php echo $id; ?>" title="Cancel Booking" class="dropdown-item ajax-popup-link tips "><i class="fas fa-fw fa-times"></i>Cancel</a>
                                                                    <?php }
                                                                    }
                                                                  }
                                                                }
