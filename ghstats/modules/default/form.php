...
// Inclusions
require_once(SYSBASE.'ghstats/includes/fn_form.php');
        ...
        foreach($result as $row){
            ...
            if($id_lang == DEFAULT_LANG || $id_lang == 0){
                ...
                if(db_column_exists($db, 'pm_'.MODULE, 'users')){
                    ...
                    if(!in_array($_SESSION['ghs']['type'], array('administrator', 'manager', 'editor')) && !in_array($_SESSION['ghs']['id'], $users)){
                        header('Location: index.php?view=list');
                        exit();
                    }
                }
...
<head>
    <?php include(SYSBASE.'ghstats/includes/inc_header_form.php'); ?>
</head>
<body>
    <div id="overlay"><div id="loading"></div></div>
    <div id="wrapper">
        <?php
        include(SYSBASE.'ghstats/includes/inc_top.php');
        
        if(!in_array('no_access', $permissions)){
            include(SYSBASE.'ghstats/includes/inc_library.php'); ?>
            <div class="form_wrapper">
            <form id="form" class="form-horizontal" role="form" action="post.php?view=form" method="post" enctype="multipart/form-data">
                <div id="page-wrapper">
                    ...
                    <div class="container-fluid">
                        ...
                        if($db !== false){ ?>
                            ...
                            <input type="hidden" name="user_role_type_2[0]" value="<?php echo $_SESSION['ghs']['type']; ?>"/>
                                            ...
                                            <div id="lang_<?php echo $id_lang; ?>" class="<?php if(MULTILINGUAL) echo 'tab-pane fade'; if(DEFAULT_LANG == $id_lang) echo ' in active'; ?>">
                                                ...
                                                foreach($fields as $tableName => $fields_table){
                                                    if($tableName != MODULE){
                                                        ...
                                                        if($id_lang == DEFAULT_LANG || $id_lang == 0 || $fields_table['table']['multi'] == 1){ ?>
                                                            ...
                                                            <div class="row mb10 <?php echo MODULE.'_row'; ?>" id="row_<?php echo $tableName; ?>">
                                                ...
                                                if($id_lang == DEFAULT_LANG || $id_lang == 0){
                                                    if(in_array('publish', $permissions) || in_array('all', $permissions)){
                                                        if(RELEASE){ ?>
                                                            <div class="row mb10 spanwrap">
                                                                <label class="col-md-2 control-label"><?php echo $texts['VALIED_FROM']; ?></label>
                                                            ...
                                                            <div class="row mb10 spanwrap">
                                                                <label class="col-md-2 control-label"><?php echo $texts['VALIED_TO']; ?></label>
                                                                <div class="col-md-6 form-inline ">
                                                                    <?php
                                                        ...
                                                        if(VALIDATION){ ?>
                                                            <div class="row mb10">
                                                                <label class="col-md-2 control-label"><?php echo 'Status'; //$texts['RELEASE']; ?></label>
                                                                <div class="col-md-6">
                                                                    <label class="radio-inline">
                                                                        <input name="checked" type="radio" value="1"<?php if($checked == 1){ echo ' checked="checked"';} ?> <?php if($mode == 'Add'){ echo ' checked="checked"';} ?> />&nbsp;<?php echo $texts['PUBLISHED']; ?><br>
                                                                    </label>
                                                                    <label class="radio-inline">
                                                    ...
                                                    if($_SESSION['ghs']['type'] == 'administrator' && db_column_exists($db, 'pm_'.MODULE, 'users')){ ?>
                                                    <div class="row mb10 userwrap">
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    <label class="col-lg-2 control-label"><?php echo $texts['USER']; ?></label>
                                                                    <div class="col-lg-10">
                                                                        <div class=" form-inline">
                                                                            <select name="users_tmp[]" multiple="multiple" id="users_tmp" size="8" class="form-control">
                                                                                <?php
                                                                                $type = array('administrator');
                                                                                $result_user = $db->query('SELECT * FROM pm_stats_user WHERE type NOT IN(\''.implode("','", $type).'\') AND id NOT IN(\''.implode("','", $users).'\') ORDER BY login');
                                                                            ...
                                                                            <select name="users[]" multiple="multiple" id="users" size="8" class="form-control">
                                                                                <?php
                                                                                $result_user = $db->query('SELECT * FROM pm_stats_user WHERE id IN(\''.implode("','", $users).'\') ORDER BY login');
                                                                                if($result_user !== false){
                                                                                    foreach($result_user as $user){ ?>
